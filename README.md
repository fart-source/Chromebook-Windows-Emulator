...
This is a toolkit that allows you to create a Windows emulator for your chromebook.

# Instructions

  1. On your chromebook, download/clone this repository.
  ...
  4. Open Virtual Box with Wine.
  
  5. Follow Virtual Box's instructions to create a virtual Windows PC.
